...
- Rules evaluate three checks (any subset can be enabled):
...
- Auto-disputed invoices are labeled with reasons like *Rate variance*, *ERP mismatch*, or *Missing POD* — carriers see these same labels.
