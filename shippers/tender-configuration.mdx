...
**Where to find it:** `Quotes → open any quote → Sending Configuration card`
...
Open any rate quote from the **Quotes** page. Below the rate response table you'll see the **Sending Configuration** card. It shows a summary of what will be sent on tender, and a **Configure** button to adjust the settings.
...
### Quote price write-back

If your organization has freight cost recording enabled, the tendered price is automatically written back to your order management system. This appears automatically when applicable — there's no toggle to configure.
