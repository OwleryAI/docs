...
Common auto-dispute labels include **Rate variance**, **ERP mismatch**, and **Missing POD** — these tell you exactly what needs to be fixed.
...
5. **Exceptions refresh.** Price variance, missing POD, and ERP mismatch flags are recomputed against the new data.
