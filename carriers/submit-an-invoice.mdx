...
<Tabs>
  ...
  <Tab title="Set up EDI Connection">
    ...
    <Warning>
      The **Shipment ID** you send on the EDI 210 must match the **Load Number** in Owlery exactly. If it doesn't match, the shipper won't be able to tie the invoice back to the load, and payment is likely to be significantly delayed. If you entered the wrong Load Number when accepting the tender, update it before invoicing — see [Edit a Load Number](/carriers/edit-a-load-number).
    </Warning>
  </Tab>
</Tabs>
